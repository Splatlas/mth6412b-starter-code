...
function write_tour(filename::String, tour::Array{Int}, cost::Int64)
...
function reconstruct_picture(tour_filename::String, input_name::String, output_name::String; view::Bool=true)
	tour = Int[]
